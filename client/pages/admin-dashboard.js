            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="mt-4">
                    <div className="flex items-center text-sm text-gray-600">
                      <span className="text-green-600 font-medium">{stats.publishedCourses}</span>
                      <span className="mx-1">published</span>
                      <span className="text-gray-400 mx-1">•</span>
                      <span className="text-yellow-600 font-medium">{stats.draftCourses}</span>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="mt-4">
                    <div className="flex items-center text-sm text-gray-600">
                      <span className="text-blue-600 font-medium">{stats.adminUsers}</span>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="mt-4">
                    <div className="flex items-center text-sm text-gray-600">
                      <span className="text-green-600 font-medium">{stats.completedOrders}</span>
                      <span className="mx-1">completed</span>
                      <span className="text-gray-400 mx-1">•</span>
                      <span className="text-yellow-600 font-medium">{stats.processingOrders}</span>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-blue-600">{stats.totalUsers - stats.adminUsers}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Total Revenue</span>
                      <span className="font-semibold text-purple-600">${stats.totalRevenue}</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg shadow overflow-hidden">
                ...
                {orders.length === 0 ? (
                  <div className="px-6 py-12 text-center">
                    ...
                    <p className="text-gray-600">Orders will appear here once users make purchases</p>
                  </div>
                ) : (
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {orders.map(order => (
                          <tr key={order._id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm font-medium text-gray-900">{order.course?.title || 'Unknown Course'}</div>
                              <div className="text-sm text-gray-500">{order.course?.instructor?.name || 'Unknown Instructor'}</div>
                            </td>
              ...
              <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    {selectedUser.avatar ? (
                      ...
                      <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center">
                        <span className="text-lg font-semibold text-gray-600">{selectedUser.name?.charAt(0)?.toUpperCase()}</span>
                      </div>
                    )}
                    <div>
                  ...
                  <div className="border-t pt-3">
                    <p><span className="font-medium">Role:</span> <span className={`px-2 py-1 text-xs rounded-full ${
                    ...
                    {selectedUser.purchasedCourses && selectedUser.purchasedCourses.length > 0 && (
                      <p><span className="font-medium">Courses:</span> {selectedUser.purchasedCourses.length}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 max-w-lg w-full mx-4">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-3 rounded">
                    <p><span className="font-medium">Order ID:</span> #{selectedOrder._id.slice(-8)}</p>
                    <p><span className="font-medium">Date:</span> {new Date(selectedOrder.createdAt).toLocaleDateString()}</p>
                    <p><span className="font-medium">Status:</span> <span className={`px-2 py-1 text-xs rounded-full ${
                  ...
                  <div className="border-t pt-3">
                    ...
                    <p><span className="font-medium">Title:</span> {selectedOrder.course?.title || 'Unknown Course'}</p>
                    <p><span className="font-medium">Instructor:</span> {selectedOrder.course?.instructor?.name || 'Unknown'}</p>
