...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Registration successful! Welcome to CourseHub!');
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`input pl-10 ${errors.name ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        <FiEyeOff className="h-5 w-5 text-gray-400 hover:text-gray-600 dark:hover:text-white" />
                      ) : (
                        <FiEye className="h-5 w-5 text-gray-400 hover:text-gray-600 dark:hover:text-white" />
                      )}
                    </button>
                  </div>
                  {errors.password && (
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-white">Or continue with</span>
                  </div>
                </div>
                ...
                <div>
                  <a
                    href="/auth/google"
                    className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors"
                  >
